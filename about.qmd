...
Raquel is a member of the [ViEW](http://view0.webs.uvigo.es/){target="_blank"} research project (Variation in English Worldwide), [LVTC](http://lvtc.uvigo.es/){target="_blank"} (Language Variation and Textual Categorisation) research group and [ELC](http://elc.org.es/){target="_blank"} (English Linguistics Circle) network.
